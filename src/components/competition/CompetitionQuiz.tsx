...
const CompetitionQuiz: React.FC<CompetitionQuizProps> = ({
  ...
  // Per-question timer
  useEffect(() => {
    if (timeLeft > 0 && questions.length > 0 && competition.quiz_preferences?.timeLimitEnabled) {
      const timer = setTimeout(() => setTimeLeft(timeLeft - 1), 1000);
      return () => clearTimeout(timer);
    } else if (timeLeft === 0 && questions.length > 0 && competition.quiz_preferences?.timeLimitEnabled) {
      handleNextQuestion();
    }
